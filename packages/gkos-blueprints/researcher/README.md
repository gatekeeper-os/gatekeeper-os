...
Apply with `gkos blueprint apply researcher --agent researcher-worker --yes`. Reapply refuses drift instead of overwriting edits. `gkos blueprint diff --agent researcher-worker` reports changed paths without exposing contents.
