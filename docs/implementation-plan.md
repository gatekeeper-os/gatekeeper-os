...
| Gatekeeper tool names | `gk_<vendor>_<resource>_<verb>` e.g. `gk_github_repo_list_issues` | Kernel matcher lists explicit `gk_*` tool IDs; unambiguous audit. |
