...
const config = {
  ...
  agents:{defaults:{workspace:join(state,'workspace'),model:{primary:'spike/spike'}}},
  tools:{profile:'full'},
  plugins:{allow:['spike-probe'],load:{paths:[resolve('scripts/spike-probe')]},entries:{'spike-probe':{enabled:true,hooks:{allowConversationAccess:true}}}}
};
