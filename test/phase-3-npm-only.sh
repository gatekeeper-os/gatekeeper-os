...
npm install --global --prefix /home/tester/npm-acceptance-prefix --ignore-scripts --registry=https://registry.npmjs.org \
  @gatekeeper-os/shared@0.1.0-beta.3 @gatekeeper-os/gatekeeper-kit@0.1.0-beta.3 \
  @gatekeeper-os/kernel@0.1.0-beta.3 @gatekeeper-os/gatekeeper-fs@0.1.0-beta.3 \
  @gatekeeper-os/cli@0.1.0-beta.3 > /home/tester/npm-only-install.log 2>&1
node registry.mjs
