// Disposable-VM-only synthetic provider. Never packaged with gkos-gatekeeper-mcp.
import { join } from "node:path";
import { writeFileSync } from "node:fs";
import { Type } from "typebox";
import { defineGatekeeper } from "@gatekeeper-os/gatekeeper-kit";
import { FixtureNotesServer, NotesFixture } from "../../../packages/gkos-gatekeeper-mcp/src/testing/notes-fixture.js";
import { proposedTools } from "../../../packages/gkos-gatekeeper-mcp/src/tools.js";
import { boundaryResource, denied } from "../../../packages/gkos-gatekeeper-mcp/src/manifest.js";
import { describeAppend } from "../../../packages/gkos-gatekeeper-mcp/src/server.js";
if (process.env.GKOS_KERNEL_VM !== "1" || process.env.OPENCLAW_STATE_DIR !== "/home/tester/.openclaw-kernel-test" || process.cwd() !== "/home/tester/src") throw denied();
...
export default defineGatekeeper({
  id: "gkos-gatekeeper-mcp", vendor: "mcp", apiVersion: 1, name: "VM-only synthetic notes",
