...
result=invoke('clawos',['config','apply','--cell','kernel-test','--json']);
...
const rules=effective.plugins.entries['clawos-kernel'].config.install;
...
result=invoke('clawos',['config','apply','--cell','kernel-test','--force','--json']);
