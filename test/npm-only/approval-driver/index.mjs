...
import {defineGatekeeper} from '/home/tester/npm-acceptance-prefix/lib/node_modules/@clawkeepers/gatekeeper-kit/dist/index.js';
...
export default defineGatekeeper({id:'gatekeeper-fixture',vendor:'fixture',apiVersion:1,name:'Npm acceptance approval fixture',description:'Test-only approval decision fixture',tools,resources,actions:{gk_fixture_record:{describe:description}},createVendor(){
